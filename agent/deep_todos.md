...
- [x] 使用者批准 v0.1.2，標籤指向已驗證程式 c00b488，未覆寫既有版本。
- [x] Release workflow 35038549060 全部成功，四個 Linux 執行檔與校驗碼公開；正式參數安裝／上報及更新保留驗收通過。
- [x] 更新繁體中文發行說明、使用文件與最終驗證證據；收尾僅文件提交。
...
- [x] 使用者批准發布 v0.1.1，標籤指向已驗證程式 7359ffc，不覆寫舊版本。
- [x] Release workflow 35028677753 全部成功，四個執行檔與校驗碼正式公開，免 ID 安裝與真實上報驗收通過。
- [x] 更新發行說明、使用文件與驗證紀錄；收尾僅文件提交。
